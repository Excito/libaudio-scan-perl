 ...
 *
 * $Id: /sd/opensource/trunk/Audio-Scan/libid3tag/utf8.c 59610 2009-10-17T01:38:41.390924Z andy  $
 */
...
#ifdef _MSC_VER
  New(0, ucs4, id3_utf8_length(utf8) + 1, id3_ucs4_t);
#else
...
#ifdef _MSC_VER
  New(0, utf8, length + 1, id3_utf8_t);
#else
